...
const checkoutSchema = Joi.object({
  ...
  deliverySlotId: Joi.string().uuid().required().messages({
    'string.base': 'Delivery slot ID must be a string',
    'string-guid': 'Delivery slot ID must be a valud UUID',
    'any.required': 'Please select a delivery time slot'
  })
});
